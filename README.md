...
Workflow
Clean raw/messy sample data in Excel
Build PivotTables, charts, and formula-driven KPIs in Excel
Load the cleaned data into MySQL and reproduce the same analysis in SQL
...
```
├── excel/
│   └── Healthcare_Claims_Analytics_Portfolio_Project.xlsx   # Raw + cleaned data, PivotTables, charts, KPI dashboard
├── sql/
...
```
SQL Highlights
The SQL script (`/sql/healthcare_claims_analysis.sql`) covers:
